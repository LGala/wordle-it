...
P
  ...
  var Ea = function(e) {
      ...
      return o(t, [{
          ...
          value: function() {
              ...
              a.textContent = this.getAttribute("text"), this._duration = 10000 || 1e3, "Infinity" !== this._duration && setTimeout((function() {
  ...
  var Qa = "IN_PROGRESS",
      Za = "WIN",
      es = "FAIL",
      as = ["Auguri Marta!", "Auguri Marta!", "Auguri Marta!", "Auguri Marta!", "Auguri Marta!", "Auguri Marta!"],
      ss = function(e) {
          n(t, e);
          var a = h(t);
          ...
          return o(t, [{
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      (a.path || a.composedPath && a.composedPath()).includes(s) && ([Za, es].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === Za && (s.setAttribute("win", ""), e.addToast(as[e.rowIndex - 1], 2e3)), e.gameStatus === es && e.addToast("marta".toUpperCase(), 1 / 0), setTimeout((function() {
                          e.showStatsModal()
